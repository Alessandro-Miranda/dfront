      ...
      var t = elementorModules.frontend.handlers.Base,
        n = t.extend({
          ...
          getDefaultElements: function () {
            return { $container: this.findElement(this.getSettings('container')) };
          },
          ...
          getSlickSettings: function () {
            ...
            return (
              (t.slidesToShow = parseInt(this.getElementSettings('slides_to_show')) || 1),
        ...
        a = t.extend({
          ...
          runFilter: function () {
            ...
            d(this.$element, function (e) {
              t.elements.$container.isotope({ filter: e }), '*' !== e && (n.selector = e), h(n);
            });
          },
          onElementChange: function (e) {
            -1 !==
              ['layout', 'image_height', 'columns', 'image_margin', 'enable_popup'].indexOf(e) &&
              this.run();
          },
          run: function () {
            var e = this;
          ...
          getDefaultSettings: function () {
            ...
            return (
              'yes' == this.getElementSettings('max_row_height') &&
                (t = { maxRowHeight: +this.getElementSettings('row_height.size') || 150 }),
              c.extend(e, t)
            );
          },
          getDefaultElements: function () {
        ...
        o = t.extend({
          ...
          run: function () {
            ...
            0 != this.wrapper.length &&
              ...
              (a =
                'scroll' + (n = this.wrapper.data('scroll-direction')) + parseInt(a) + parseInt(r)),
              ...
              c.keyframe.define([{ name: a, '0%': r, '100%': { transform: 'translateX(-101%)' } }]),
              e.playKeyframe({
                name: a,
          ...
          c.each(
            {
              ...
              'ha-threesixty-rotation.default': function (a) {
                var e,
                  ...
                  d = circlr(t, { play: !0 });
                'on' === n
                  ? ((e = a.find('.ha-threesixty-rotation-autoplay')).on('click', function (e) {
                  ...
                  : l.on('click', function (e) {
                      ...
                      e.hasClass('hm-play-button')
                        ? (e.removeClass('hm-play-button'), e.addClass('hm-stop'), d.play())
                        : (e.removeClass('hm-stop'), e.addClass('hm-play-button'), d.stop()),
                        s.remove();
                    }),
                  o.on('click', function (e) {
                    a.find('img').each(function () {
                      -1 !== c(this).attr('style').indexOf('block') &&
                        (HappySimplaMagnify(c(this)[0], r), o.css('display', 'none'), s.remove());
                    });
                  }),
                  c(document).on('click', function (e) {
                    var e = c(e.target),
                      ...
                      n = o.find('i');
                    t.length && e[0] !== n[0] && (t.remove(), o.removeAttr('style')),
                      e[0] === i[0] && s.remove();
                  }),
              ...
              'ha-data-table.default': function (e) {
                ...
                e.find('.ha-table__body-row').each(function (e, t) {
                  c(t)
                    ...
                    .each(function (e, t) {
                      c(t).prepend(
                        '<div class="ha-table__head-column-cell">' + n.eq(e).html() + '</div>'
                      );
                    });
                });
              },
                    ...
                    eventClick: function (e) {
                      if ('yes' == k) {
                        ...
                        w.css('display', 'none'),
                          ...
                          r && (f.removeAttr('style'), f.find('span.ha-ec-event-guest').text(r)),
                          l && (g.removeAttr('style'), g.find('span.ha-ec-event-location').text(l)),
                          ...
                          !0 !== a
                            ...
                            : (m.removeAttr('style'), m.find('span.ha-ec-event-time').text(S)),
                          c &&
                            (v.removeAttr('style'),
                            v.attr('href', c),
                  ...
                  _.find('.ha-ec-popup-wrapper').on('click', function (e) {
                    e.stopPropagation(),
                      (e.target !== e.currentTarget &&
                        ...
                        x.addClass('ha-ec-popup-removing').removeClass('ha-ec-popup-ready');
                  }));
              },
                ...
                n.on('submit', function (e) {
                  ...
                  c.ajax({
                    ...
                    success: function (e) {
                      n.trigger('reset'),
                        e.status
                          ? (a.removeClass('error'), a.addClass('success'), a.text(i))
                          : (a.addClass('error'), a.removeClass('success'), a.text(e.msg));
                  ...
                  t =
                    ('yes' == t &&
                      (n.on('mousemove', function (e) {
                        ...
                        a.css('transform', 'translate(' + 0.3 * t + 'px, ' + 0.5 * e + 'px)');
                      }),
      ...
      elementorFrontend.hooks.addAction(
        ...
        function (e, t) {
          ...
          elementorFrontend.isEditMode()
            ...
            : elementorFrontend.isEditMode() ||
              ((a = (n = e.find('.ha-age-gate-wrapper')).data('age_gate_cookies_time')),
              ...
              '' != i && null != i && new Date(o) <= new Date(i)
                ? (t('.ha-age-gate-wrapper').hide(), n.closest('body').css('overflow', ''))
                : ('' != i &&
                    null != i &&
              ...
              e.find('.ha-age-gate-wrapper.ha-age-gate-confirm-dob').length &&
                t('.ha-age-gate-confirm-dob-btn').on('click', function () {
                  ...
                  o.getFullYear() - e < t(this).closest('.ha-age-gate-wrapper').data('userbirth')
                    ? t(this).closest('.ha-age-gate-boxes').find('.ha-age-gate-warning-msg').show()
                    : (localStorage.setItem('ha-age-gate-expire-time', s),
                      t(this).closest('.ha-age-gate-wrapper').hide(),
                      t(this).closest('body').css('overflow', ''));
                }),
              e.find('.ha-age-gate-wrapper.ha-age-gate-confirm-by-boolean').length &&
                (t('.ha-age-gate-wrapper .ha-age-gate-confirm-yes-btn').on('click', function () {
                  localStorage.setItem('ha-age-gate-expire-time', s),
                    t(this).closest('.ha-age-gate-wrapper').hide(),
                    t(this).closest('body').css('overflow', '');
                }),
