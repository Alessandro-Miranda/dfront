            ...
            .forEach((t) => {
              ...
              (s.breakpoints[r[t].value] = {
                ...
                e.image_spacing_custom &&
                  (s.breakpoints[r[t].value].spaceBetween = this.getSpaceBetween(t)),
        ...
        onTabClick(e) {
          e.preventDefault(),
            this.changeActiveTab(
              e.currentTarget?.getAttribute(this.getSettings('dataAttributes').tabIndex),
              !0
            );
        }
        getTabEvents() {
      ...
      var r = n(1695),
        ...
        exportWebAssemblyErrorCauseWrapper = function (e, t) {
          if (l && l[e]) {
            var n = {};
            (n[e] = o(a + '.' + e, t, c)),
              r({ target: a, stat: !0, constructor: !0, arity: 1, forced: c }, n);
          }
        };
