(() => {
  class RocketLazyLoadScripts {
      ...
      (EventTarget.prototype.addEventListenerBase = EventTarget.prototype.addEventListener),
        (EventTarget.prototype.addEventListener = function (e, i, o) {
          'click' !== e ||
            t.windowLoaded ||
            i === t.clickHandler ||
            t.interceptedClickListeners.push({ target: this, func: i, options: o }),
    ...
    t() {
      this._(this),
        'loading' === document.readyState
          ? document.addEventListener('DOMContentLoaded', this.R.bind(this))
          : this.R();
    }
    p() {
      let t = [];
    ...
    async U(t) {
      const e = t.shift();
      return e && e.isConnected ? (await this.B(e), this.U(t)) : Promise.resolve();
    }
    I() {
      this.j(
        ...
        if (o && o.fn && !t.allJQueries.includes(o)) {
          o.fn.ready = o.fn.init.prototype.ready = function (e) {
            return (
              t.domReadyFired
                ? e.bind(document)(o)
                : document.addEventListener('rocket-DOMContentLoaded', () => e.bind(document)(o)),
              o([])
            );
          };
          const e = o.fn.on;
    ...
    async J() {
      ...
      (t.persisted = this.persisted),
        ...
        await this.G(),
        window.rocketonpageshow && window.rocketonpageshow({ persisted: this.persisted }),
        (this.windowLoaded = !0);
    }
    m() {
      document.onreadystatechange && document.onreadystatechange(),
        window.onload && window.onload(),
        window.onpageshow && window.onpageshow({ persisted: this.persisted });
    }
    q() {
      const t = new Map();
      document.write = document.writeln = function (e) {
        ...
        o.setStart(c, 0), c.appendChild(o.createContextualFragment(e)), n.insertBefore(c, s);
      };
    }
    async G() {
